...
public class ActionClass  extends BaseClassofOrange{
...
/////////////////////////////////////////
	...
	*/
	...
	public String captureScreen() throws IOException {
		...
		String dest =System.getProperty("user.dir") + "\\ScreenShots\\" + getCurrentTime()+ ".png";

		File target = new File(dest);
		FileUtils.copyFile(src, target);
		return dest;
	}
	public String getCurrentTimeaction() {
